export const basicMessages = {
  start: (userName: string) =>
    `🏃‍♂️ Olá, ${userName}! Bem-vindo ao VELOX Bot! 🎉\n\n` +
    `🏆 **Sobre a VELOX:**\n` +
  ...
  about:
    ...
    `**📊 Plataforma Completa:**\n` +
    `• Calendário de eventos em tempo real\n` +
    `• Sistema de alertas inteligentes\n` +
    `• Comunidade ativa de corredores\n` +
    `• Planilhas de treino profissionais\n\n` +
    `Junte-se à nossa comunidade! 🚀`,

  sponsorship:
    `🤝 **Programa de Patrocínio VELOX**\n\n` +
    `**🎯 Por que patrocinar a VELOX?**\n` +
  ...
  mediaRestriction:
    ...
    `❓ **Precisa de ajuda?** Use /ajuda para ver todos os comandos disponíveis!`,
} as const;
